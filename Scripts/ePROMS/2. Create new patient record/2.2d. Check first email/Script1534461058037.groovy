...
WebUI.verifyMatch(unreadClass, 'zF', false, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.click(findTestObject('Gmail/Inbox/First email sender'))
...
WebUI.waitForElementVisible(findTestObject('TrueNTH/Register for TrueNTH page/TrueNTH Header Logo'), 20)
