...
WebUI.waitForElementClickable(findTestObject('TrueNTH/Patient Profile page - staff/Send email button'), 10)
...
WebUI.waitForElementVisible(findTestObject('Gmail/Log in/Email field'), 30)
