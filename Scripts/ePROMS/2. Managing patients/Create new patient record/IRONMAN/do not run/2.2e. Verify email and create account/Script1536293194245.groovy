...
WebUI.waitForElementPresent(findTestObject('TrueNTH/Register for TrueNTH page/TrueNTH Header Logo'), 60)

WebUI.delay(1)

WebUI.setText(findTestObject('TrueNTH/Register for TrueNTH page/Password field'), GlobalVariable.userPassword)

WebUI.setText(findTestObject('TrueNTH/Register for TrueNTH page/Retype password field'), GlobalVariable.userPassword)
...
WebUI.waitForElementVisible(findTestObject('TrueNTH/Questionnaires page/Go to questionnaire button'), 120)
