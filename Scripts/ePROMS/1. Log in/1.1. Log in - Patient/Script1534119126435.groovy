...
WebUI.setText(findTestObject('TrueNTH/Log in page/Email address field'), GlobalVariable.testUsername)

WebUI.setText(findTestObject('TrueNTH/Log in page/Password field'), GlobalVariable.testPassword)
